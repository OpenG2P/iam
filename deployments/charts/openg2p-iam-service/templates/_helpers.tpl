...
*/}}
{{- define "iamStaffPortalApi.serviceAccountName" -}}
...
*/}}
{{- define "iamStaffPortalApi.imagePullSecrets" -}}
...
*/}}
{{- define "iamStaffPortalApi.baseEnvVars" -}}
{{- $context := .context -}}
{{- range $k, $v := .envVars }}
- name: {{ $k }}
...
{{- define "iamStaffPortalApi.envVars" -}}
