...
export async function GET(req: NextRequest) {
  ...
  const url = `${backendConfig.backendApiUrl}/auth/start_authentication_transaction?id=${backendConfig.loginProviderId}&redirect_uri=${encodeURIComponent(redirectUri)}`;
